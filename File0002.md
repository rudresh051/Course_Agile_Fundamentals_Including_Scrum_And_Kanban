...
Every few weeks you're actually able to look in see how it's going, and make adjustments as
necessary to make the team even more successful.
```

## Activity - Your top 5 Agile Priciples

![alt text](image-4.png)

![alt text](image-5.png)

## Activity - Instructor Jeremy Response

![alt text](image-6.png)

## Activity - Instructor Vivek Response
