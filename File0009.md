...
and then go ahead and create a board.
Then you simply can create your lists,
and you can utilize this for your professional
or your personal activities that need to get completed.
You put your various chores on here for your house.
You could put different tasks on here for work,
however you want to do it.
But I think that utilizing it,
even if you're not using kanban currently at work,
utilizing this for your own personal items
will really help you to get used
to the concept of seeing your To Do list,
choosing the next high priority item,
going ahead and taking ownership of that,
and moving that to in progress,
eliminating those number of works in progress,
and then moving them to Done.
```

## Activity : Setup Trello

## Activity : Follow Along with Trello #2
...
```txt
: Now, one thing to remember with Kanban.
Kanban is looking to adjust its framework
to match the processes and whatnot of the organization
that's adopting that framework.
And so this Kanban board,
everything that we've shown you has been to-do,
doing, and done.
And that is the base Kanban board that is recommended,
it's to-do, doing, and done, three statuses.
But because Kanban is looking to conform
to your organization, these really could be anything.
You could have six different columns with statuses
and those statuses could be created,
approved, in progress, testing,
moved to production, or done.
So you could have a lot of different statuses,
and really conform it to how your organization handles that.
Now, one thing to keep in mind
when you utilize different statuses
and columns in your Kanban board, is you generally
are gonna still be using those key metrics
for Kanban, the lead time and the cycle time.
While lead time will still generally be
from creation to completion,
cycle time may be a little different.
You may have from in-progress, through testing,
and to done.
So you may have an extra status in there
which is still accounting for that cycle time.
So it's just something you have to think through,
and make a conscious, explicit policy,
or decision on what is cycle time to us?
What is considered a time when that work
is in progress until it's actually done
to really track that cycle time?
So I just wanna take a moment
and just say that to-do, doing, and done
is not how all Kanban boards are set up
and quite frankly,
most organizations don't have it set up so simply.
They usually have some other testing,
or approval phases in there.
And so when you move it through,
you get it to those different pieces.
So I wanted to make sure that towards the end
of this section, I at least let you know that,
and so you can conform that to meet your needs,
or the needs of your organization.
```
...
```txt
-: Another concept that I at least wanted to touch on
is the concept of Kanban Swimlanes.
Swimlanes in Kanban are utilized to group tasks together.
This could be grouping them together based on
the department that's going to be responsible
for completing them.
Could be grouped together based on
the title or responsibilities of the person
or people that are going to be completing them.
You could have grouped based on high priority,
medium priority, low priority, whatever you want to do.
You can group however you want.
And the swimlanes are done in a different way
...
> And remember, Kanban's all about stop starting, start finishing. You need a complete task. Complete the task
...
```txt
Almost everybody has a Kanban board, even in their home
and it's gaining a lot of popularity.
And what we are looking
at is kind of the tip of the iceberg,
which is the first thing is visualizing your work.
Which is very important aspect
of any project that you want
to visualize your work, right?
And that's what Kanban actually literally means.
-: Oh, does it?
-: The Japanese. -: Oh, that sounds.
-: It's a signal board.
It's like, you have a visual signal of the work.
```
...
```txt
-: So in conclusion, Kanban is an awesome Agile framework
that can really help mature organizations
that have been utilizing Agile a lot
and been doing it successfully in other frameworks,
a way to kind of take a step back and breathe
and really form the framework
around their organizational processes,
rather than forming their organizational processes
to that particular framework.
But also, don't forget, Kanban is awesome for startups,
small team startups, as well as personal productivity.
```
