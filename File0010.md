...
```txt
And I've seen the Scrumban get used a lot
when companies are immature.
They start their scrum, right?
-: Yeah.
-: They maybe start Agile
for the first time they develop their scrum
they follow that, that real prescriptive approach
and step by step, and here's rules you need to follow.
And then they're like, you know what?
We wanna move, we're now mature.
We've been doing this for a number of years.
-: Yeah.
-: And we want something that we can mold a little bit more.
-: Hundred percent.
-: And so then they want to go to Kanban,
but that jump from Scrum to Kanban is pretty,
-: Yeah.
-: pretty drastic.
-: Yeah.
-: That's a big leap
so they use Scrumban to really help them
remove a little bit of structure,
-: Yeah.
-: but keep a little bit of structure and go to Kanban,
er, a Scrumban, and work with that for a while
before they eventually potentially move to full on Kanban.
```
